...
public final class Route extends TransitEntity {
    ...
    private List<GroupOfLines> groupsOfLines = new ArrayList<>();
    ...
    public List<GroupOfLines> getGroupsOfLines() {
        return groupsOfLines;
    }

    public void addGroupOfLines(Collection<GroupOfLines> groupsOfLines) {
        this.groupsOfLines.addAll(groupsOfLines);
    }
}
